            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 titulos">
                        <h1>Usuarios sin cuenta/Cambio de cuenta</h1>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a class="btn btn-outline-success" href="adduserSC.php">Agregar usuario</a>
                            ...
                            <tbody>
                                <?php foreach ($results as $row) {  ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edituserSC.php?Id=<?php echo $row['Id']?>" class="btn btn-warning">Editar</a>
                                            <a target="_blank" href="fichaSC.php?Id=<?php echo $row['Id']?>" class="btn btn-info">Ficha</a>
